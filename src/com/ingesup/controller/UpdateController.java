...
public class UpdateController extends HttpServletUtils {
	...
	public void update() {
		...
		if(this.request.getMethod().toUpperCase().equals("POST"))
			this.updatePost();
		// 2. GET: in case of request to display on the admin monitor
//		else if(this.request.getMethod().toUpperCase().equals("GET"))
//			this.updateGet();
...
//	/**
//	 * Display a view with all the recents history for each computer of the park
//	 */
//	public void updateGet() {
//		
//		List<History> lastHistory = HistoryManager.getRecentList();
//		
//		if(lastHistory != null){
//			this.request.setAttribute("historyList", lastHistory);
//			this.displayView();
//		}
//	}
